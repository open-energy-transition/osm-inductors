...
Currently, the repository contains the following python scripts and folders :
  ...
  2. **fetch_wiki_info_by_country.py**, which fetches classes and subclasses of any Qid that can be found in wikidata. To search and find a Qid, modify them accordingly in the config.yaml file.
